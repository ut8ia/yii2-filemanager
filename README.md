...
```
php composer.phar require --prefer-dist ut8ia/yii2-filemanager "*"
```
...
Apply migration
```sh
yii migrate --migrationPath=vendor/ut8ia/yii2-filemanager/migrations
```
...
'modules' => [
    'filemanager' => [
        'class' => 'ut8ia\filemanager\Module',
        // Upload routes
        'routes' => [
