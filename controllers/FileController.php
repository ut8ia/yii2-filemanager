...
namespace ut8ia\filemanager\controllers;

use ut8ia\filemanager\models\MediafileSearch;
use Yii;
...
use ut8ia\filemanager\assets\FilemanagerAsset;
use yii\helpers\Url;
...
class FileController extends Controller
{
    ...
    {
        $this->layout = '@vendor/ut8ia/yii2-filemanager/views/layouts/main';
