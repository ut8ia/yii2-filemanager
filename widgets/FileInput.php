 ...
 * More samples of usage see on github: https://github.com/ut8ia/yii2-filemanager
 *
 * @package ut8ia\filemanager\widgets
...
class FileInput extends InputWidget
{
    ...
    public function run()
    {
        ...
        $modal = $this->renderFile('@vendor/ut8ia/yii2-filemanager/views/file/modal.php', [
